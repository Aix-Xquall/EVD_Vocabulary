...
GNSS protection is required near high-power transmitters.
...
External RF EME should be tailored to the launch and test environment.

外部 RF 電磁環境應依發射與測試環境裁剪。

**Example 2**

The RF receiver must remain functional under the specified external RF EME.
...
**Category:** ESD / P-static / Lightning
...
Large systems, especially those with EMI concerns, need a dedicated return.
...
**Category:** Electromagnetic Compatibility (EMC) / EMI
...
A stable chassis reference improves EMI repeatability.
...
## 437. intra-system Electromagnetic Compatibility (EMC)
...
## 466. subject to final confirmation
...
## 696. installation configuration
