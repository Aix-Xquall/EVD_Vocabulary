...
class Settings:
    ...
    tts_provider: str = _text_env("EVD_TTS_PROVIDER", "google")
    ...
    google_english_voice: str = _text_env("GOOGLE_ENGLISH_VOICE", "en-US-Neural2-F")
    ...
    azure_tenant_id: str = _text_env("AZURE_TENANT_ID")
    azure_client_id: str = _text_env("AZURE_CLIENT_ID")
    azure_client_secret: str = _text_env("AZURE_CLIENT_SECRET")
    azure_subscription_id: str = _text_env("AZURE_SUBSCRIPTION_ID")
    azure_speech_resource_group: str = _text_env("AZURE_SPEECH_RESOURCE_GROUP")
    azure_speech_resource_name: str = _text_env("AZURE_SPEECH_RESOURCE_NAME")
    ...
    tense_annotations_path: Path = Path(
        _text_env(
            "EVD_TENSE_ANNOTATIONS_PATH",
